    ...
    <div class="mb-6">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                ...
                <p class="text-sm text-zinc-600 mt-1">Kelola informasi akun dan profil lahan pertanian Anda</p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-zinc-200 overflow-hidden mb-6">
        <div class="bg-gradient-to-r from-green-500 to-emerald-500 px-6 py-4">
            <div class="flex items-center justify-between">
                <div class="flex items-center">
                    ...
                    <h2 class="text-lg font-bold text-white">Profil Petani</h2>
                </div>
                <button wire:click="openPetaniModal"
                    ...
                    {{ $petaniProfile ? 'Edit Profil Lahan' : 'Lengkapi Profil Lahan' }}
                </button>
            </div>
        </div>
        @if ($petaniProfile)
        ...
        @else
            <div class="p-12 text-center">
                ...
                <p class="text-zinc-500 font-medium mb-2">Profil lahan belum dilengkapi</p>
                <p class="text-xs text-zinc-400 mb-4">Lengkapi profil lahan untuk mulai berjualan</p>
                <button wire:click="openPetaniModal"
        ...
        <script>
            ...
            $wire.on('petani-profile-updated', () => {
                Swal.fire({
                    ...
                    position: 'top-end',
                    icon: 'success',
                    title: 'Profil lahan berhasil diperbarui!',
                    showConfirmButton: false,
                    timer: 3000,
                    timerProgressBar: true,
                });
